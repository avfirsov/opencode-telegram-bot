...
export const ru: I18nDictionary = {
  ...
  "rename.no_session":
    "⚠️ Нет активной сессии для переименования. Используйте /sessions для выбора или /new для создания.",
  "rename.prompt": "✏️ Пришлите новое название сессии:",
  "rename.cancel": "❌ Отмена",
  "rename.cancelled": "❌ Операция переименования отменена.",
  "rename.empty":
    "⚠️ Название сессии не может быть пустым или содержать только пробелы. Пришлите корректное название:",
  "rename.success": "✅ Сессия переименована в: {title}",
  "rename.error": "🔴 Не удалось переименовать сессию. Попробуйте снова.",
  "rename.inactive_callback": "Эта операция переименования уже неактивна.",
};
